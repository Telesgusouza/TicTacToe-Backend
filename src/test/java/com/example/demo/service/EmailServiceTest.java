...
public class EmailServiceTest {
	...
	public void resetPassword_VeryShortTicket() {
		...
		assertThrows(TicketException.class,
				() -> this.emailService.resetPassword(new ResetPasswordDTO("test@gmail.com", "12345", "password_123")));
	}
	...
	public void resetPassword_WrongPasswordPassed() {
		...
		assertThrows(InvalidFieldException.class,
				() -> this.emailService.resetPassword(new ResetPasswordDTO("test@gmail.com", "123456", "12345")));
	}
